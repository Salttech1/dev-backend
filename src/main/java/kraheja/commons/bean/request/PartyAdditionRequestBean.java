...
@NoArgsConstructor
@AllArgsConstructor
public class PartyAdditionRequestBean implements Serializable {
	...
	private PartycontactinfoRequestBean partycontactinfoRequestBean;
	
	private Partyenterpriseinfo partyenterpriseinfo;
